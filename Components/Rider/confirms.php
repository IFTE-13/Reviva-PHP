                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="py-3.5 px-4 text-sm font-normal text-left rtl:text-right text-gray-400">Type</th>
                        ...
                        <?php
                            while($myrow = $confirmPickUp->fetch_assoc()){
                                $weightClass = getWeightClass($myrow['weight']);
                                $statusText = getStatusText($myrow['status']);
                                echo '<tr>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                     <h2 class="font-medium text-white capitalize">' . $statusText . '</h2>
                                </td>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <form method="POST">
                                        <div class="flex items-center gap-x-6">
                                            <button type="submit" name="confirmProduct" value=' . $myrow['id'] . ' class="text-gray-500 transition-colors duration-200 dark:hover:text-red-500 dark:text-gray-300 hover:text-red-500 focus:outline-none">
