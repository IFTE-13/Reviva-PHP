    ...
    <div class="container px-6 py-3 mx-auto md:flex">
        ...
        <div class="w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
            <div class="flex flex-row ml-10 gap-x-3">
                ...
                <a href="http://localhost/fixit/View/Admin/transactions.php" class="p-1.5 text-gray-300 focus:outline-nones transition-colors duration-200 rounded-lg hover:text-blue-500">
                ...
                <a href="http://localhost/fixit/View/Admin/feedback.php" class="p-1.5 text-gray-300 focus:outline-nones transition-colors duration-200 rounded-lg hover:text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square-dashed"><path d="M3 6V5c0-1.1.9-2 2-2h2"/><path d="M11 3h3"/><path d="M18 3h1c1.1 0 2 .9 2 2"/><path d="M21 9v2"/><path d="M21 15c0 1.1-.9 2-2 2h-1"/><path d="M14 17h-3"/><path d="m7 17-4 4v-5"/><path d="M3 12v-2"/></svg>
                </a>
            </div>
