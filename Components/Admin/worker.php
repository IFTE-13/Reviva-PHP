    ...
    <?php include("navbar.php"); ?>
            ...
            <div id="modal" class="hidden fixed z-10 inset-0 overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input name="name" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-700 focus:ring-opacity-40 focus:outline-none focus:ring">
                        </div>
                        <div>
                            <label class="text-gray-700">Username</label>
                            <input name="username" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-700 focus:ring-opacity-40 focus:outline-none focus:ring">
                        </div>
                        <div>
                            <label class="text-gray-700" for="emailAddress">Email Address</label>
                            <input name="email" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-700 focus:ring-opacity-40 focus:outline-none focus:ring">
                        </div>
                        <div>
                            <label class="text-gray-700" for="emailAddress">Address</label>
                            <input name="address" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md  focus:border-blue-400 focus:ring-blue-700 focus:ring-opacity-40 focus:outline-none focus:ring" value='<?php echo $_SESSION['address']; ?>' >
                        </div>
                    ...
                    <?php echo $registrationWorkerError?>
            ...
            <div class="inline-block min-w-full w-full divide-y align-middle">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php
                    while($myrow = $workers->fetch_assoc()){
                        echo '<tr>';
