                ...
                <form method="POST">
                  ...
                  <div class="relative mb-4" data-twe-input-wrapper-init>
                    <input
                      type="text"
                      name="username"
                      class="block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] focus:placeholder:opacity-100"
                  ...
                  <div class="flex items-center justify-between pb-6">
                    ...
                    <button
                      ...
                      data-twe-ripple-init
                      data-twe-ripple-color="light">
                      <a href="http://localhost/PCFixer/View/register.php">Register</a>
                    </button>
                  </div>
                </form>
              </div>
