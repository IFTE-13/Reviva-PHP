...
<html lang="en">
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a href="http://localhost/fixit/View/index.php" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 cursor-pointer">
    ...
    <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
      <a href="http://localhost/fixit/View/services.php" class="mr-5 hover:text-orange-600">Services</a>
      <a href="http://localhost/fixit/View/about.php" class="mr-5 hover:text-orange-600">About</a>
      <a href="http://localhost/fixit/View/contact.php" class="mr-5 hover:text-orange-600">Contact</a>
      <a href="http://localhost/fixit/View/faq.php" class="mr-5 hover:text-orange-600">FAQ</a>
    </nav>
