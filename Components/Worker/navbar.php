    ...
    <div class="container px-6 py-3 mx-auto md:flex">
        ...
        <div class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
            <div class="flex flex-col px-2 -mx-4 md:flex-row md:mx-10 md:py-0">
                <a href="http://localhost/fixit/View/Worker/serviceRequest.php" class="px-2.5 py-2 text-gray-200 transition-colors duration-300 transform rounded-lg hover:text-blue-500 hover:bg-gray-700 md:mx-2">Service Request</a>
                <a href="http://localhost/fixit/View/Worker/Transaction.php" class="px-2.5 py-2 text-gray-200 transition-colors duration-300 transform rounded-lg hover:text-blue-500 hover:bg-gray-700 md:mx-2">Transaction</a>
            </div>

            <div class="relative mt-4 md:mt-0">
                <div class="flex flex-col md:flex-row md:mx-6 items-center gap-x-4">
                    <a href="http://localhost/fixit/View/Worker/settings.php" class="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400"><?php echo $_SESSION['name']?></a>
