                ...
                <form method="POST">
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input value='<?php echo $_SESSION['id']; ?>' type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-300 rounded-md" readonly>
                        </div>
                        <div>
                            <label class="text-gray-700">Name</label>
                            <input name="name" value='<?php echo $_SESSION['name']; ?>' type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md">
                        </div>
                        <div>
                            <label class="text-gray-700">Username</label>
                            <input value='<?php echo $_SESSION['username']; ?>' type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-300 border border-gray-200 rounded-md" readonly>
                        </div>
                        <div>
                            <label class="text-gray-700" for="emailAddress">Email Address</label>
                            <input name="email" value='<?php echo $_SESSION['email'];  ?>' type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md">
                        </div>
                        <div>
                            <label class="text-gray-700" for="emailAddress">Address</label>
                            <input name="address" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" value='<?php echo $_SESSION['address']; ?>' >
                        </div>
    
                        <div>
                            <label class="text-gray-700" for="emailAddress">Phone</label>
                            <input name="phone" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md" value='<?php echo $_SESSION['phone']; ?>'>
                        </div>
                    </div>
                ...
                <form method="POST">
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-1">
                        <div>
                            ...
                            <input name="password" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md">
                        </div>
                        <div>
                            <label class="text-gray-700">Confirm Password</label>
                            <input name="confirmPassword" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md">
                        </div>
                    </div>
                    <?php echo $updateInformation?>
                    <div class="flex justify-end mt-6">
